...
import { ProductAiFormModalProps, ProductAiFormResponse } from '@/types/product/types';
import { Dialog, Transition } from '@headlessui/react';
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome';
import { faXmark } from '@fortawesome/free-solid-svg-icons';
import ProductAiForm from '@/components/product/form/productAiForm';

const ProductAiFormModal: React.FC<ProductAiFormModalProps> = (
  {
    isOpen,
    onClose,
    onReturn,
  ...
  const handleAiResponse = async (responseObj: ProductAiFormResponse) => {
...
export default ProductAiFormModal;
